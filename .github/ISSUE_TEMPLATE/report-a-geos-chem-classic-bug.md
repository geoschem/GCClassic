---
name: Report a bug with the GEOS-Chem-Classic wrapper
about: Use this template to report bugs or issues with the GEOS-Chem-Classic wrapper code.
title: "[BUG/ISSUE]"
labels: bug
assignees: ''
...
# Report a bug or issue with the GEOS-Chem-Classic wrapper code:
...
<!--- please post an issue on the main GEOS-Chem repository at this link: -->
